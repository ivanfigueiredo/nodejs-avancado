...
import { mockSaveSurveyResultRepository, mockLoadSurveyResultRepository } from '../../../test/'
...
describe('DbSaveSurveyResult UseCase', () => {
  ...
  test('Should call LoadSurveyResultRepository with correct values', async () => {
    ...
    expect(loadBySurveyByIdSpy).toHaveBeenCalledWith(surveyResultData.surveyId)
  })
